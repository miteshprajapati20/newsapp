...
const News =(props)=> {
    ...
    const capatalizefirstlatter =(string)=>{
    ...
    useEffect( ()=>{
        document.title = `${capatalizefirstlatter(props.category)}-NewsWorld`;
        update();
       ...
       setPage(page+1);
        ...
        return (
            <div>
                    ...
                    <h1 className='text-center' style={{margin : '40px 0px ' , marginTop : "90px"}}>NewsWorld - Top {capatalizefirstlatter(props.category)} Headlines</h1>
                    {/* {loading && <Spinner />} */}
                    <InfiniteScroll
